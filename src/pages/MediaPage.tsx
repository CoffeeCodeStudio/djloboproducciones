  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6" aria-labelledby="event-highlights-heading">
        ...
        {isLoading ? (
          <div className="columns-2 sm:columns-3 gap-4 sm:gap-5 [column-fill:_balance]">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="mb-4 sm:mb-5 break-inside-avoid aspect-[4/3] glass-card animate-pulse bg-muted/20 rounded-xl" />
            ))}
          </div>
        ) : filtered.length > 0 ? (
          <div className="columns-2 sm:columns-3 gap-4 sm:gap-5 [column-fill:_balance]">
